  ...
  App.room = App.cable.subscriptions.create("RoomChannel", {
    ...
    received: function(data) {
      if (data.content.blank == null) {
        $("#message-content").append('<div class="panel-body body-panel">' + '<ul class="chat">' + '<li class="left clearfix"><span class="chat-img pull-left">' + '<img src="' + user + '" alt="User Avatar" class="rounded-circle img-fluid profile-image" />' + '</span>' + '<div class="chat-body clearfix">' + '<div class="header">' + '<strong class="primary-font">' + data.username + '</strong> <small class="pull-right text-muted">' + '<i class="fa fa-clock-o" aria-hidden="true"></i>' + data.time + ' ago' + '</small>' + '</div>' + '<p class="wrap">' + data.content + '</p>' + '</div>' + '</li>' + '</ul>' + '</div>');
